...
CLASSES_NAMES_MAPPING_PATH = "data/artifitial-data/plane-images/class_names_to_id_mapping.json"
...
class ImageCreator:
    ...
    """
    SMALL_PLANES = {"mig29", "mig31", "su24", "su25", "su27_su35", "su30_su34"} #"l39", 
    ...
    def __choose_plane_image(self, plane_type: str) -> PlaneImage:
        ...
        match plane_type:
            case "s":
                ...
                plane_id = CLASSES_NAMES_MAPPING[plane_file_name[:-2]]
            case "b":
