...
PATH_TO_SAVE = "data/artifitial-data/artifitial-images-dataset-v4"
...
if __name__ == "__main__":
    ...
    image_creator = ImageCreator(path_to_airbase_images_folder=PATH_TO_ARBASE_IMAGES_FOLDER,
                                ...
                                start_index=0)
    image_creator.generate_dataset(number_of_images=2500)
    split_dataset_files(os.path.join(PATH_TO_SAVE, "labels"), os.path.join(PATH_TO_SAVE, "images"), "data/dataset-russian-planes-artifitial-v4", train_size=0.8, test_size=0.05)
    t2 = time()
    print(t2-t1)